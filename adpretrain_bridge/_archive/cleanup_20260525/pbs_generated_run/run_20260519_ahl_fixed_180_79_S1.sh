...
mkdir -p /ghome/huangjd/code/detected/adpretrain_bridge/output/20260519_ahl_plain_fixed_180_79_stage_v3/stages/S1/logs
/gdata1/huangjd/miniconda3/envs/adpretrain_ahl_bridge/bin/python run_fewshot_ahl_stage_val_threshold.py \
  ...
  --epochs 30 \
  --cluster-num 2 \
  2>&1 | tee /ghome/huangjd/code/detected/adpretrain_bridge/output/20260519_ahl_plain_fixed_180_79_stage_v3/stages/S1/logs/run_ahl.log
/gdata1/huangjd/miniconda3/envs/adpretrain_ahl_bridge/bin/python evaluate_fewshot_stage_metrics_val_threshold.py \
  ...
  2>&1 | tee /ghome/huangjd/code/detected/adpretrain_bridge/output/20260519_ahl_plain_fixed_180_79_stage_v3/stages/S1/logs/evaluate_metrics.log
