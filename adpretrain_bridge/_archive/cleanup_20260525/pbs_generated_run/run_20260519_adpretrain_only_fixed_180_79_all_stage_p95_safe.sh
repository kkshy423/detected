...
OUT=/ghome/huangjd/code/detected/adpretrain_bridge/output/20260519_adpretrain_only_fixed_180_79_all_stage_p95_safe
mkdir -p "$OUT/logs"
/gdata1/huangjd/miniconda3/envs/adpretrain_ahl_bridge/bin/python evaluate_qm_xiepai_adpretrain_only_fixed_180_79.py \
  ...
  2>&1 | tee "$OUT/logs/evaluate_adpretrain_only_fixed_180_79_all_stage_p95_safe.log"
