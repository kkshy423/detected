...
class initDataloader():
    ...
    def get_cluster(self, train_set, test_set):
        ...
        if len(normal_feature) == 0:
            raise ValueError(
                "No normal training features were loaded before clustering. "
                f"Check dataset_root={self.args.dataset_root}, "
                f"classname={self.args.classname}, feat_classname={self.args.feat_classname}, "
                "and supported image extensions."
            )
